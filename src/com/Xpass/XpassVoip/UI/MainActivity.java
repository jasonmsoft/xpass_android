...
import com.Xpass.XpassVoip.xpass_service.XpassService;
...
public class MainActivity extends Activity
{
	...
	protected void startXpassService()
	{
		Log.d("activity", "start xpass service start ....");
		XpassSrvUtil.info("start activity, service start ........");
		Intent intent = new Intent(this, XpassService.class);
...
//        }
	...
	private class MainActivityHandler extends Handler
	{
		...
		public void handleMessage(Message msg)
		{
			...
			{
				int callId = msg.arg1;
				XpassPjsipApp.getInstance().ringCall(callId);
				XpassPjsipApp.getInstance().setCurrentCall(callId);
				String uri = XpassPjsipApp.getInstance().getCalleeUri(callId);
			...
			case XpassPjsipMessageType.Xpass_PJSIP_MESSAGE_TYPE_CALL_STATE:
			{
				...
				{
					Message m = Message.obtain(CallActivity.handler_, XpassPjsipMessageType.Xpass_PJSIP_MESSAGE_TYPE_CALL_STATE, msg.obj);
					m.sendToTarget();
				}
			}
			break;
